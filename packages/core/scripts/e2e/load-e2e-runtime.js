...
function loadResources() {
  ...
  ixEsm.setAttribute('src', '/www/build/siemens-ix.esm.js');

  var ix = document.createElement('script');
  ix.setAttribute('nomodule', '');
  ix.setAttribute('src', '/www/build/siemens-ix.js');
  ...
  ixBrandEsm.setAttribute(
    'src',
    '/www/build/ix-brand-theme/ix-brand-theme.esm.js'
  );

  var ixBrand = document.createElement('script');
  ixBrand.setAttribute('nomodule', '');
  ixBrand.setAttribute('src', '/www/build/ix-brand-theme/ix-brand-theme.js');
